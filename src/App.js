...
import "./App.css";
import Paraghraph from "./paragraph";
import Slides from "./slide";
import Brandslogo from "./interdoctors";
import Platform from "./platform";
import Stats from "./statistics";
import Paraghraph1 from "./paragraph1";
...
function App() {
  ...
  const navtitles = [
    ...
    {a:false,
      ...
      sousMenu: [
        "Departments",
        "Customers success and Sales",
        "IT, Product ,Design, UX "
      ]
    }
  ];
  const headertext = {
    link: "https://www.docplanner.com/img/sygnet.png",
    text: "Making the healthcare experience more human"
  };
  const slide = [
    {
      patient: true,
  ...
  let brandlogo = [
    {
      link:
        "https://www.znanylekarz.pl/?_ga=2.157644030.51744213.1576156103-1228955159.1576156103",
      targ: "_blank",
  ...
  let platformtext = {
    txt: "The world's",
    txt0: "biggest healthcare platform",
  ...
  let paragraph1 = {
    txt: "Improve the lives of millions.",
    txt1: " Change yours forever",
    txt2: "More than 1000 team mates share our same vision, goals and passion.",
    txt3: "With offices in Warsaw, Barcelona, Istanbul, Rome, Mexico City and",
    txt4: "Curitiba, our search for great talent never stops."
  };
  ...
  let foot = {
    t: "we are leaders in 10 countries",
    t1: "Poland",
    t2: "Turkey",
    t3: "Spain",
    t4: "Italy",
  ...
  return (
    <div className="App">
      ...
      <Paraghraph para={paras} />
      <Slides slide={slide} />

      <Brandslogo logos={brandlogo} />
      <div className="main3">
        <Platform plat={platformtext} />
        <Stats stat={stats} />
      </div>
      <div className="mainborder">
        <Paraghraph1 parag={paragraph1} />
        <Image tab={tabimg} />
        <Footer data={foot} />
      </div>
    </div>
